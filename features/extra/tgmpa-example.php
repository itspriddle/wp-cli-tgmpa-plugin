...
// Example TGMPA plugin code
add_action( 'tgmpa_register', 'example_tgmpa_register_required_plugins' );

function example_tgmpa_register_required_plugins() {
	/*
	...
	$config = array(
		...
		/*
		'strings'      => array(
			'page_title'                      => __( 'Install Required Plugins', 'example-tgmpa' ),
			'menu_title'                      => __( 'Install Plugins', 'example-tgmpa' ),
			'installing'                      => __( 'Installing Plugin: %s', 'example-tgmpa' ), // %s = plugin name.
			'oops'                            => __( 'Something went wrong with the plugin API.', 'example-tgmpa' ),
			...
			'return'                          => __( 'Return to Required Plugins Installer', 'example-tgmpa' ),
			'plugin_activated'                => __( 'Plugin activated successfully.', 'example-tgmpa' ),
			'activated_successfully'          => __( 'The following plugin was activated successfully:', 'example-tgmpa' ),
			'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', 'example-tgmpa' ),  // %1$s = plugin name(s).
			'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', 'example-tgmpa' ),  // %1$s = plugin name(s).
			'complete'                        => __( 'All plugins installed and activated successfully. %1$s', 'example-tgmpa' ), // %s = dashboard link.
			'contact_admin'                   => __( 'Please contact the administrator of this site for help.', 'example-tgmpa' ),
